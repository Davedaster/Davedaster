...
function CompletionCard({ tracking, primaryColour, proofPhotos }: { tracking: Tracking; primaryColour: string; proofPhotos: Array<{ id: string; url: string; label?: string | null }> }) {
  ...
  const completedAt = isCollection ? collection?.collectedAt || stop.actualArrival || proofPhotos[0]?.createdAt || null : stop.actualArrival || pod.receiverMark?.createdAt || proofPhotos[0]?.createdAt || null;
